(function () {
    ...
    mw.settings = {
        ...
        debug: true,
        basic_mode: false,
        site_url: 'http://104.248.106.77/',
        template_url: 'http://104.248.106.77/userfiles/templates/bootstrap5/',
        modules_url: 'http://104.248.106.77/userfiles/modules/',
        includes_url: 'http://104.248.106.77/userfiles/modules/microweber/',
        upload_url: 'http://104.248.106.77/api/upload/',
        api_url: 'http://104.248.106.77/api/',
        libs_url: 'http://104.248.106.77/userfiles/modules/microweber/api/libs/',
        api_html: 'http://104.248.106.77/api_html/',
        ...
        edit_area_placeholder: '<div class="empty-element-edit-area empty-element ui-state-highlight ui-sortable-placeholder"><span>Veuillez faire glisser les éléments ici</span></div>',
        empty_column_placeholder: '<div id="_ID_" class="empty-element empty-element-column">Veuillez faire glisser les éléments ici</div>',
        handles: {
            item: "<div title='Cliquez pour sélectionner cet élément.' class='mw_master_handle' id='items_handle'></div>"
        },
        sorthandle_delete_confirmation_text: "Êtes-vous sûr de vouloir supprimer cet élément?"
    }
    ...
    mw.msg = mw._lang = {
        ...
        contentunpublished: "Le contenu n&#039;est pas publié",
        contentpublished: "Le contenu est publié",
        save: "Sauvegarder",
        saving: "Économie",
        saved: "Enregistré",
        settings: "Réglages",
        ...
        remove: "Supprimer",
        close: "Fermer",
        to_delete_comment: "Êtes-vous sûr de vouloir supprimer ce commentaire",
        del: "Voulez-vous vraiment le supprimer?",
        save_and_continue: "Enregistrer &amp;amp; Continuer",
        before_leave: "Partir sans économiser",
        session_expired: "Votre session a expiré",
        login_to_continue: "Merci de vous connecter pour continuer",
        more: "Suite",
        templateSettingsHidden: "Paramètres du modèle",
        less: "Moins",
        product_added: "Votre produit est ajouté au panier",
        no_results_for: "Aucun résultat pour",
        switch_to_modules: 'Passer aux modules',
        switch_to_layouts: 'Passer aux mises en page',
        loading: 'Chargement',
        edit: 'Éditer',
        change: 'Changement',
        submit: 'Nous faire parvenir',
        settingsSaved: 'Les paramètres sont enregistrés',
...
mw.askusertostay = false;
  ...
  if (top === self){
    window.onbeforeunload = function() {
      if(mw.askusertostay){
        mw.notification.warning("Vous avez des changements non enregistrés!");
        return "Vous avez des changements non enregistrés!";
      }
    }
  }

  warnOnLeave = function(){
     mw.tools.confirm("Vous avez des changements non enregistrés! Êtes-vous sûr?");
  };
  ...
  mw.require = function(url, inHead, key) {
    ...
    var t = url.split('.').pop();
    url = url.contains('//') ? url : (t !== "css" ? "http://104.248.106.77/userfiles/modules/microweber/api/" + url  :  "http://104.248.106.77/userfiles/modules/microweber/css/" + url);
...
mw.required.push("http://104.248.106.77/userfiles/modules/microweber/api/jquery.js");



mw.required.push("http://104.248.106.77/userfiles/modules/microweber/api/tools.js");
mw.required.push("http://104.248.106.77/userfiles/modules/microweber/api/tools/cookie.js");



mw.required.push("http://104.248.106.77/userfiles/modules/microweber/api/forms.js");

mw.required.push("http://104.248.106.77/userfiles/modules/microweber/api/url.js");

mw.required.push("http://104.248.106.77/userfiles/modules/microweber/api/events.js");

//mw.required.push("http://104.248.106.77/userfiles/modules/microweber/api/upgrades.js");
mw.required.push("http://104.248.106.77/userfiles/modules/microweber/api/session.js");

mw.required.push("http://104.248.106.77/userfiles/modules/microweber/api/shop.js");

mw.required.push("http://104.248.106.77/userfiles/modules/microweber/api/common.js");

mw.required.push("http://104.248.106.77/userfiles/modules/microweber/api/components.js");

mw.required.push("http://104.248.106.77/userfiles/modules/microweber/api/dialog.js");
mw.required.push("http://104.248.106.77/userfiles/modules/microweber/api/instruments.js");
mw.required.push("http://104.248.106.77/userfiles/modules/microweber/api/forms.js");
mw.required.push("http://104.248.106.77/userfiles/modules/microweber/api/fonts.js");

//mw.required.push("http://104.248.106.77/userfiles/modules/microweber/api/content.js");
...
mw.required.push('http://104.248.106.77/userfiles/modules/microweber/api/tools/base64.js');
...
mw.required.push('http://104.248.106.77/userfiles/modules/microweber/api/tools/checkbox.js');
...
mw.required.push('http://104.248.106.77/userfiles/modules/microweber/api/tools/colorpicker.js');
...
mw.required.push('http://104.248.106.77/userfiles/modules/microweber/api/tools/common-extend.js');
...
mw.required.push('http://104.248.106.77/userfiles/modules/microweber/api/tools/common.js');
...
mw.required.push('http://104.248.106.77/userfiles/modules/microweber/api/tools/dialog.js');
...
mw.required.push('http://104.248.106.77/userfiles/modules/microweber/api/tools/domhelpers.js');
...
mw.required.push('http://104.248.106.77/userfiles/modules/microweber/api/tools/dropdown.js');
...
mw.required.push('http://104.248.106.77/userfiles/modules/microweber/api/tools/editor.js');
...
mw.required.push('http://104.248.106.77/userfiles/modules/microweber/api/tools/element.js');
...
mw.required.push('http://104.248.106.77/userfiles/modules/microweber/api/tools/elementedit.js');
...
mw.required.push('http://104.248.106.77/userfiles/modules/microweber/api/tools/external.js');
...
mw.required.push('http://104.248.106.77/userfiles/modules/microweber/api/tools/extradata-form.js');
...
mw.required.push('http://104.248.106.77/userfiles/modules/microweber/api/tools/fullscreen.js');
...
mw.required.push('http://104.248.106.77/userfiles/modules/microweber/api/tools/gallery.js');
...
mw.required.push('http://104.248.106.77/userfiles/modules/microweber/api/tools/helpers.js');
...
mw.required.push('http://104.248.106.77/userfiles/modules/microweber/api/tools/iframe-tools.js');
...
mw.required.push('http://104.248.106.77/userfiles/modules/microweber/api/tools/images.js');
...
mw.required.push('http://104.248.106.77/userfiles/modules/microweber/api/tools/jquery.tools.js');
...
mw.required.push('http://104.248.106.77/userfiles/modules/microweber/api/tools/loading.js');
...
mw.required.push('http://104.248.106.77/userfiles/modules/microweber/api/tools/loops.js');
...
mw.required.push('http://104.248.106.77/userfiles/modules/microweber/api/tools/modules-dialogs.js');
...
mw.required.push('http://104.248.106.77/userfiles/modules/microweber/api/tools/native-notification.js');
...
mw.required.push('http://104.248.106.77/userfiles/modules/microweber/api/tools/notification.js');
...
mw.required.push('http://104.248.106.77/userfiles/modules/microweber/api/tools/objects.js');
...
mw.required.push('http://104.248.106.77/userfiles/modules/microweber/api/tools/responsive.js');
...
mw.required.push('http://104.248.106.77/userfiles/modules/microweber/api/tools/select.js');
...
mw.required.push('http://104.248.106.77/userfiles/modules/microweber/api/tools/spinner.js');
...
mw.required.push('http://104.248.106.77/userfiles/modules/microweber/api/tools/storage.js');
...
mw.required.push('http://104.248.106.77/userfiles/modules/microweber/api/tools/system-dialogs.js');
...
mw.required.push('http://104.248.106.77/userfiles/modules/microweber/api/tools/tabs.js');
...
mw.required.push('http://104.248.106.77/userfiles/modules/microweber/api/tools/tooltip.js');
...
mw.required.push('http://104.248.106.77/userfiles/modules/microweber/api/tools/uiaccordion.js');
