...
$config['stylesheet_compiler']['settings']['hr'] = array('type' => 'dropdown', 'default' => "'../img/hr.svg'", 'label' => 'Choose your prefered delimeter');
...
$config['template_settings']['header_style'] = array('type' => 'dropdown', 'default' => 'header_style_2', 'label' => 'Navigation Style');
