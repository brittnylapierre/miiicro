...
<ul class="socials-2">
    ...
    <?php if ($soundcloud_enabled) { ?>
        <li>
            <a href="//soundcloud.com/<?php print $soundcloud_url; ?>" target="_blank" data-toggle="x-tooltip" data-placement="top" title="SoundCloud"><i class="mdi mdi-soundcloud"></i></a>
        </li>
    <?php } ?>

    <?php if ($mixcloud_enabled) { ?>
        <li>
            <a href="//mixcloud.com/<?php print $mixcloud_url; ?>" target="_blank" data-toggle="x-tooltip" data-placement="top" title="MixCloud"><i class="mdi mdi-mixcloud"></i></a>
        </li>
    <?php } ?>
