<?php $user = get_user_by_id(user_id()); ?>
    ...
    <form class="col-12 mb-5 mx-auto" method="post" id="user-data">
        ...
        <div class="form-group">
            <label class="control-label"><?php _lang("Username", "templates/wine"); ?></label>
        ...
        <div class="form-group">
            <label class="control-label"><?php _lang("Email", "templates/wine"); ?></label>
        ...
        <div class="form-group">
            <label class="control-label"><?php _lang("First name", "templates/wine"); ?></label>
        ...
        <div class="form-group">
            <label class="control-label"><?php _lang("Last name", "templates/wine"); ?></label>
        ...
        <div class="form-group">
            <label class="control-label"><?php _lang("New Password", "templates/wine"); ?></label>
            <input class="form-control input-lg" type="password" name="password" placeholder="<?php _lang('New Password', "templates/wine"); ?>">
        </div>

        <div class="form-group">
            <label class="control-label"><?php _lang("Confirm Password", "templates/wine"); ?></label>
