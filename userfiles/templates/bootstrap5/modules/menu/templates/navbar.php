...
//
$menu_filter['link'] = '<a itemprop="url" data-item-id="{id}" class="menu_element_link nav-link {active_class} {exteded_classes} {nest_level} {a_class}" {target_attribute} href="{url}">
  <span class="icon-menu-item allow-drop">
    <img class="icon-menu-item-icon" src="{icon}"/>
    <span>{title}</span>
  </span>
</a>';
